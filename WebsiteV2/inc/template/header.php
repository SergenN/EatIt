            ...
            <div class="menu">
                <?php
                    ...
                    if(!isset($_SESSION['gegevens'])){
                        ...
                        if($_SESSION['soortgebruiker'] == "medewerker"){
                            echo "Welkom, {$gegevens['MED_Voornaam']} | " . (($gegevens['Afdeling'] == '1')?'<a href="?p=beheerder">Medewerkerbeheer</a> | ':"") . (($gegevens['Afdeling'] == '1')?'<a href="?p=toevoegen">Gegevensbeheer</a> | ':"") . (($gegevens['Afdeling'] == 6 || $gegevens['Afdeling'] == 1)?'<a href="?p=keuken">Geplaatste Bestellingen</a> | ':"") . (($gegevens['Afdeling'] == 3 || $gegevens['Afdeling'] == 1 || $gegevens['Afdeling'] == 7)?'<a href="?p=inkoopfactuur">Inkoopfactuur</a> | ':"") . (($gegevens['Afdeling'] == 7 || $gegevens['Afdeling'] == 1)?'<a href="?p=BAL">BAL</a> | ':"")  . (($gegevens['Afdeling'] == '2' || $gegevens['Afdeling'] == 1)?'<a href="?p=routeplanning">Routeplanning</a> | ':"")  . " <a href=\"?p=instellingen\">Instellingen</a> |  <a href=\"?p=winkelwagen\">Winkelwagen</a> | <a href=\"?p=uitloggen\">Uitloggen</a>";
                        }
                    }
                ?>
            </div>
